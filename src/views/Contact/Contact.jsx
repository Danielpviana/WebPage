            ...
            <section className="bg-white">
                <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
                    ...
                    <form action="#" className="space-y-8">
                        <div>
                            <label className="flex justify-center mb-2 text-sm font-bold text-gray-900 dark:text-[#248566]">Your email</label>
                        ...
                        <div>
                            <label className="flex justify-center mb-2 text-sm font-bold text-gray-900 dark:text-[#248566]">Subject</label>
                        ...
                        <div className="sm:col-span-2">
                            <label className="flex justify-center mb-2 text-sm font-bold text-gray-900 dark:text-[#248566]">Your message</label>
                        ...
                        <div className="sm:col-span-2 flex justify-center">
                            <button type="submit" className="py-3 px-5 text-sm font-medium text-center text-white rounded-lg bg-[#248566] sm:w-fit hover:bg-[#1cc791] hover:text-black focus:ring-4 focus:outline-none focus:ring-primary-300">Send message</button>
                        </div>
                    </form>
                </div>
            </section>
